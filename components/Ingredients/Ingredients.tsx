          ...
          <div className={classes.ingredientYield}>
            {equipment?.length > 0 && (
              <div className={classes.equipment}>
                <Title order={4} className={classes.equipmentTitle}>Equipment</Title>
                <div className={classes.list}>
                  {equipment.map((item, i) => (
                    <Text className={classes.equipmentText} key={i}>
                      {item.equipment.title
                        .replace(/(.*?)\s?qt/g, (match, p1) => `${(parseFloat(p1) * 0.95).toFixed(1)}l`)
            ...
            <div className={classes.equipment}>
              <Title order={4} className={classes.equipmentTitle}>Timing</Title>
              <div className={classes.list}>
                <Text className={classes.equipmentText}>{timing}</Text>
              </div>
            </div>
            <div className={classes.equipment}>
              <Title order={4} className={classes.equipmentTitle}>Yield</Title>
              <div className={classes.list}>
