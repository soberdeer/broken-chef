  ...
  return (
    ...
    >
      <div style={{ position: 'absolute' }}>
        <div className={cx(classes.wrapper, className)} {...others} data-modal-container>
          <div
            className={cx(classes.inner, classes.white)}
            style={{ width }}
            data-modal-inner
          >
            {renderHeader && (
              <div className={classes.header} data-modal-header>
                ...
                <button className={classes.close} onClick={onClose} type="button" data-modal-close>
                  <X size={14} />
                </button>
              </div>
            )}
            <div className={classes.content} data-modal-children>
              {children}
            </div>
          </div>
        </div>
