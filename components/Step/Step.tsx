...
export default function Step({
  ...
  return !isAside ? (
    <div
      className={cx(className, classes.step, {
        [classes.noBottomPadding]: !directions && !image,
      })}
    >
      {order > 0 && !hideNumber && (
      ...
      <Paddings>
        {text.length > 0 && (
          <div
            ...
            style={{
              paddingTop: ingredients && ingredients.length > 0 ? 40 : 0,
            }}
            dangerouslySetInnerHTML={{ __html: text }}
          />
        )}
        {arr.length > 0 && <div>{arr}</div>}
      </Paddings>
    </div>
  ) : (
    <div
      className={cx(className, classes.step, classes.gray, {
        [classes.noBottomPadding]: !directions && !image,
      })}
    >
      <div
      ...
      >
        ...
        >
          <path d="M3 12h1m8-9v1m8 8h1M5.6 5.6l.7.7m12.1-.7l-.7.7M9 16a5 5 0 116 0 3.5 3.5 0 00-1 3 2 2 0 01-4 0 3.5 3.5 0 00-1-3m.7 1h4.6" />
        </svg>
